        ...
        <main className="bg-slate-200 text-slate-700 min-h-screen">
            <header className="flex justify-between max-w-5xl mx-auto py-4 px-2">
                ...
                <nav className="flex items-center gap-4">
                    <Link className="hover:underline">Tablero 1</Link>
                    <Link className="hover:underline">Tablero 2</Link>
                    <Link to={"/"}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8 hover:stroke-rose-700">
