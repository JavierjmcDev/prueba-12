    ...
    return <DefaultLayout>
        <section className="h-[650px] flex items-center justify-center">
            <form className="bg-slate-300 w-[350px] rounded-md shadow-md overflow-hidden">
                <fieldset className="flex flex-col justify-center items-center py-12">
                ...
                <fieldset className="flex flex-col gap-6 bg-slate-700 p-6 rounded-t-md text-slate-200">
                    ...
                    <Link to={"/dashboard"} className="bg-rose-800 rounded-md text-slate-200 py-2 text-center font-semibold hover:bg-rose-700 transition">Login</Link>
                    <label className="flex gap-2 items-center">
                        <input type="checkbox" />
                        <span className="opacity-75">Recordar contraseña</span>
                    </label>
                    <fieldset className="flex flex-col items-center">
                        <span className="opacity-75">No tiene cuenta aun?</span>
                        <Link className="hover:underline" to={"/register"}>Registrarse ahora</Link>
                    </fieldset>
